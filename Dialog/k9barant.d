...
++ ~Sounds good. Report to Kelddath in Beregost's town hall when you are able.~ DO ~  GiveItem("k9clck04",LastHeardBy())  SetGlobal("k9politicsteach","GLOBAL",1) IncrementGlobal("k9beregostprepared","GLOBAL",1) TakePartyItemNum("scrl8a",1)  AddexperienceParty(1000)  TakePartyItemNum("scrl7q",1) TakePartyItemNum("scrl7g",1) AddJournalEntry(@531119,QUEST) SetGlobal("k9barant","GLOBAL",1) EscapeArea()~  EXIT
