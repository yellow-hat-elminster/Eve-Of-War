...
IF ~~ THEN BEGIN 3
  ...
  IF ~~ THEN DO ~SetName(@74011)~ EXIT
END

IF ~~ THEN BEGIN 4
  SAY ~Very well friend. I'll be here if you change your mind.~
  IF ~~ THEN DO ~SetName(@74011)~ JOURNAL #27437 EXIT
END
...
SetGlobal("SmugglerMove","GLOBAL",1) SetGlobal("k9SmugglerMove","GLOBAL",0) SetName(@74011)
~ JOURNAL #27437 EXIT
END
